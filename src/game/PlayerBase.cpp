...
//								  &D3DXVECTOR3( 0.0f, 1.0f, 0.0f ) );
	...
	const __Vector3 vEye = D3DXVECTOR3(vChrPos.x + fCameraMoveX, vChrPos.y + fVCenter + 2.0f + fCameraMoveY, vChrPos.z + 10.0f);
	const __Vector3 vAt = D3DXVECTOR3(vChrPos.x + fCameraMoveX, vChrPos.y + fVCenter + fCameraMoveY, vChrPos.z + 0.0f);
	const __Vector3 vUp = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	D3DXMatrixLookAtLH( &mtxView, &vEye,	// 여기서 View matrix는 카메라 각도와 상관있다. 거리는 원근에 아무 영향을 미치지 않는다.
